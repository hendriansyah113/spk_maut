    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <div class="mb-3">
                    <form method="get" action="<?= base_url('Perhitungan') ?>" class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-success"><i class="fa fa-table"></i> Perkalian Matrik Normalisasi Dengan
            Bobot Kriteria</h6>
    </div>
