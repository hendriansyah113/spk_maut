		...
		<div class="row">
			...
			<div class="form-group col-md-6">
				...
				<select name="keterangan" class="form-control" required>
					...
					<option value="Aktif" <?php if ($alternatif->keterangan == "Aktif") {
												echo 'selected';
											} ?>>Aktif
					</option>
					<option value="Cuti" <?php if ($alternatif->keterangan == "Cuti") {
												echo 'selected';
											} ?>>Cuti
					</option>
				</select>
			...
			<div class="form-group col-md-6">
				...
				<input autocomplete="off" type="text" name="tahun" value="<?php echo $alternatif->tahun ?>" required
					class="form-control" />
			</div>
			...
			<div class="form-group col-md-6">
				...
				<select name="departemen" class="form-control" required>
					<option value="Manajer" <?php if ($alternatif->departemen == "Manajer") {
												echo 'selected';
											} ?>>
						Manajer</option>
					<option value="Teknisi" <?php if ($alternatif->departemen == "Teknisi") {
												echo 'selected';
											} ?>>
						Teknisi</option>
					<option value="Sales" <?php if ($alternatif->departemen == "Sales") {
												echo 'selected';
											} ?>>Sales
					</option>
					<option value="Marketing" <?php if ($alternatif->departemen == "Marketing") {
													echo 'selected';
												} ?>>
						Marketing</option>
				</select>
